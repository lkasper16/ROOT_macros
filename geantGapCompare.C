...
void geantGapCompare() {
	...
	//=======================================
	//GEM-TRD no dead gas gap
	
	TFile *file0 = TFile::Open("forKondo_GasGaps/fdc15_e-10000MeV_Xe10CO2_d21:1.1mm_r20cm_m1_noGap.root");
    ...
    TCanvas *c1 = new TCanvas("c1","200K e- with 20cm transparentR XTR, XeCO2 90:10", 2000, 1200);
    ...
    exitRad->SetTitle("No Dead Gas Gap");
	...
	//=======================================
	//GEM-TRD 400um dead gas gap
	
	TFile *file2 = TFile::Open("forKondo_GasGaps/fdc15_e-10000MeV_Xe10CO2_d21:1.1mm_r20cm_m1_400Gap.root");
    ...
    exitRad1->SetTitle("400#mum Dead Gas Gap");
	...
	TFile *file3 = TFile::Open("forKondo_GasGaps/fdc15_e-10000MeV_Xe10CO2_d21:1.1mm_r20cm_m1_2000Gap.root");
    ...
    exitRad2->SetTitle("2mm Dead Gas Gap");
	...
	c1->SaveAs("forKondo_GasGaps/GeantDeadGasGap_Scan.pdf");
	...
	//gStyle->SetStatFontSize(5);
	gStyle->SetStatX(0.76);
	gStyle->SetStatY(0.8);
	...
	gPad->SetBottomMargin(0.125);
	TH1D *cathodeSubtract1 = new TH1D("cathodeSubtract1","No Gap - 'Absorbed' Spectrum; TR Photon Energy [keV]; Count",100,0.,50.);
    ...
    cathodeSubtract1->GetYaxis()->SetTitleOffset(1.8);
	...
	gPad->SetLeftMargin(0.165);
	gPad->SetBottomMargin(0.125);
	TH1D *cathodeSubtract2 = new TH1D("cathodeSubtract2","400#mum Gap - 'Absorbed' Spectrum; TR Photon Energy [keV]; Count",100,0.,50.);
    ...
    cathodeSubtract2->GetYaxis()->SetTitleOffset(1.8);
	...
	gPad->SetLeftMargin(0.165);
	gPad->SetBottomMargin(0.125);
	TH1D *cathodeSubtract3 = new TH1D("cathodeSubtract3","2mm Gap - 'Absorbed' Spectrum; TR Photon Energy [keV]; Count",100,0.,50.);
    ...
    cathodeSubtract3->GetYaxis()->SetTitleOffset(1.8);
    //cathodeSubtract3->GetYaxis()->SetNdivisions(505);
	cathodeSubtract3->Draw();
	
	c3->SaveAs("forKondo_GasGaps/GeantDeadGasGap_DifferenceIntegrals.pdf");
	...
	c4->cd(1);
	auto rp1 = new TRatioPlot(cathodeSubtract2, cathodeSubtract1);
	//rp1->SetRightMargin(0.09);
	rp1->SetLeftMargin(0.13);
	cathodeSubtract2->SetLineColor(96);
	cathodeSubtract2->SetFillColor(96);
    cathodeSubtract2->SetFillStyle(3004);
	cathodeSubtract1->SetFillStyle(3005);
    ...
    rp1->GetLowerRefGraph()->SetMinimum(-0.5);
   	...
   	lr1->AddEntry("cathodeSubtract2", "400#mum Gap", "lf");
   	lr1->AddEntry("cathodeSubtract1", "No Gap", "lf");
   	lr1->SetTextSize(0.045);
   	lr1->Draw();
   	
   	c4->cd(2);
	auto rp2 = new TRatioPlot(cathodeSubtract3, cathodeSubtract1);
	//rp2->SetRightMargin(0.09);
	rp2->SetLeftMargin(0.13);
	cathodeSubtract3->SetLineColor(6);
	cathodeSubtract3->SetFillColor(6);
    cathodeSubtract3->SetFillStyle(3004);
	cathodeSubtract1->SetFillStyle(3005);
    ...
    rp2->GetLowerRefGraph()->SetMinimum(-0.5);
   	...
   	lr2->AddEntry("cathodeSubtract3", "2mm Gap", "lf");
   	lr2->AddEntry("cathodeSubtract1", "No Gap", "lf");
   	lr2->SetTextSize(0.045);
   	lr2->Draw();
   	
	c4->SaveAs("forKondo_GasGaps/GeantDeadGasGap_Ratios.pdf");
