...
void trd_HistMerge(){
  ...
  gPad->Update();
  if (useMax) {
    c1->SaveAs("GEMTRD_Max_ADC_Xe_Comparison_v1.C");
    c1->SaveAs("GEMTRD_Max_ADC_Xe_Comparison_v1.pdf");
  } else {
	  c1->SaveAs("GEMTRD_ADC_Xe_Comparison_v1.C");
  ...
  gPad->Update();
  if (useMax) {
    c2->SaveAs("MMG1TRD_Max_ADC_Xe_Comparison_v1.C");
    c2->SaveAs("MMG1TRD_Max_ADC_Xe_Comparison_v1.pdf");
  } else {
    c2->SaveAs("MMG1TRD_ADC_Xe_Comparison_v1.C");
  ...
  gPad->Update();
  if (useMax) {
    c3->SaveAs("URWTRD_Max_ADC_Xe_Comparison_v1.C");
    c3->SaveAs("URWTRD_Max_ADC_Xe_Comparison_v1.pdf");
  } else {
    c3->SaveAs("URWTRD_ADC_Xe_Comparison_v1.C");
...
if (makeTimeDistributions)
  ...
  */
  ...
  gPad->Modified();
  gPad->Update();
  c31->SaveAs("GEMTRD_Time_Xe_Comparison_v1.C");
  ...
  gPad->Modified();
  gPad->Update();
  c4->SaveAs("MMG1TRD_Time_Xe_Comparison_v1.C");
  ...
  gPad->Modified();
  gPad->Update(); 
  c5->SaveAs("URWTRD_Time_Xe_Comparison_v1.C");
