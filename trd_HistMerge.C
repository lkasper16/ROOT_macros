...
void trd_HistMerge(){
  ...
  TLegend *l3 = new TLegend(0.67, 0.59, 0.9, 0.865);
  ...
  gPad->Update();
  if (useMax) {
    c3->SaveAs("URWTRD_Max_ADC_Xe_Comparison_v3.C");
    c3->SaveAs("URWTRD_Max_ADC_Xe_Comparison_v3.pdf");
  } else {
...
if (makeTimeDistributions)
 {
  ...
  TLegend *l5 = new TLegend(0.33, 0.59, 0.53, 0.865);
