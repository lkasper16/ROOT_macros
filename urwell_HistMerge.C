...
void urwell_HistMerge(){
	...
	TString rootFiles[] = {"Run_006247_Output.root", "Run_006245_Output.root", "Run_006244_Output.root","Run_006261_Output.root","Run_006246_Output.root"}; //Varied TF
  ...
  //TString rootFiles[] = {"Run_006214_Output.root", "Run_006212_Output.root", "Run_006211_Output.root","Run_006261_Output.root","Run_006213_Output.root","Run_006215_Output.root","Run_006216_Output.root"}; //Varied DF
  //TString rootFiles[] = {"Run_006243_Output.root", "Run_006218_Output.root", "Run_006217_Output.root","Run_006261_Output.root","Run_006250_Output.root"}; //Varied GEM dV
  
  
	TList *histList = new TList;
	TString name1 = "urw_f125_el_x";
	int colorList[] = {94,51,209,6,7,1,4,2};
	TString legendList[] = {"1.925 kV/cm","1.95 kV/cm","1.975 kV/cm","2 kV/cm","2.025 kV/cm"}; //Varied TF
